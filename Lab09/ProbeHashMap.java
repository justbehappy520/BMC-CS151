...
public class ProbeHashMap<K,V> extends AbstractHashMap<K,V> {
  ...
  private double maxProbes; // the maximum number of probes for an insertion
  private double totalProbes; // the total number of probes
  ...
  protected void createTable() {
    ...
    maxProbes = 0; // intialize maxProbes to 0
  }

  /** Returns true if location is either empty or the "defunct" sentinel. */
  private boolean isAvailable(int j) {
    return (j < 0 || table[j] == null || table[j] == DEFUNCT);
  }
  ...
  private int findSlot(int h, K k) {
    ...
    double probes = 0;                               // probe counter for current insertion
  ...
  // extra methods specifically for Lab09
  /**
   * Returns an int of the average number of probes for the program.
   * 
   * @return int of average probes
   */
  public double computeAvgProbes() {
    return totalProbes / (double) size();
  }

  /**
   * Returns an int of the max number of probes for any one insertion.
   * 
   * @return int of maximum probes
   */
  ...
  /**
   * Returns a double of how much of the capacity is full.
   * 
   * @return double of filled capacity
   */
